    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      <div class="container mx-auto px-4 py-12 max-w-2xl">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm mb-6">
          <h2 class="text-lg font-bold text-gray-900 mb-3">Pair with a running agent</h2>
          <PairForm />
        </div>
        ...
        <div class="rounded-2xl border border-emerald-200 bg-emerald-50/40 p-6 shadow-sm space-y-3">
          <div class="flex items-center gap-2">
            ...
            <h2 class="text-lg font-bold text-gray-900">First time? Install the agent</h2>
          </div>
          <p class="text-sm text-gray-700">
            cfg never reaches your device directly — a tiny Linux daemon called <strong>chyi-cfg-agent</strong>
            runs on the same network as the device, and proxies commands from this site to it.
            One operator installs it once; everyone else just visits this URL.
          </p>
          ...
          <ol class="text-sm text-gray-700 list-decimal list-inside space-y-1">
            ...
            <li>Wait for the agent to print a pair code (e.g. <code class="font-mono text-xs">ABCD-EFGH</code>).</li>
            <li>Enter the code above to bind your browser to that agent for 24 hours.</li>
          </ol>
          <p class="text-xs text-gray-500">
            See <a href="/docs/agent" class="underline hover:text-blue-600">docs/agent</a> for
            requirements (glibc, x86_64-linux, libCFApi.so) and troubleshooting.
          </p>
        </div>

        <div class="mt-6 text-center text-xs text-gray-500">
          <a href="/" class="hover:text-blue-600 underline">← Back to config editor</a>
        </div>
      </div>
    </div>
  );
